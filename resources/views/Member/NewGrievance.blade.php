...
<main class="main-content p-4 invisible" data-qp-animate-type="fadeIn" data-qp-animate-delay="600" role="main">
        <form action="{{route('GrievanceMember')}}" method="post" enctype="multipart/form-data">
        {{ csrf_field()}}
        <table width="95%">
            <thead>
                <tr>
        ...
        <table width="95%" style="border-bottom: 2px solid;padding-bottom: 20px;">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" style="width: 50%;" value="{{ Auth::user()->name }}"></td>
                </tr>
                <tr>
                    <td><h5 style="text-transform: uppercase;"><b>Membership Code</b></h5></td>
                    <td><input type="text" style="width: 50%;" value="{{ Auth::User()->membership_code }}"></td>
                </tr>
                <tr>
                    <td><h5 style="text-transform: uppercase;"><b>Date of submitting Greivence</b></h5></td>
                    <td><input type="text" style="width: 50%;" value="{{ date('d-M-Y') }}"></td>
                </tr>
                <tr>
                ...
                <tr>
                     <td colspan="2"><textarea rows="4" cols="50" style="height: 250px;" name="member_text">{{ old('member_text') }}</textarea></td>
                </tr>
                <tr>
                     <td colspan="2"><h4>if space is not enough please attach your greivence with this form.</h4></td>
                </tr>
                <tr>
                    <td width="400px"><h5 style="text-transform: uppercase;"><b>Upload File</b></h5></td>
                    <td><input type="file" name="docs" style="width: 50%;"></td>
                </tr>
                <tr>
                    <td width="400px"><h5 style="text-transform: uppercase;"><b>Sign of member</b></h5></td>
                    <td><input type="file" name="member_signature" style="width: 50%;" required></td>
                </tr>
                <!--tr>
                    <td width="400px"><h5 style="text-transform: uppercase;"><b>signature of lobby head</b></h5></td>
                    <td><input type="file" name="" style="width: 50%;"></td>
                </tr>
                <tr>
                    <td><h5 style="text-transform: uppercase;"><b>details of core commitee decision on greivence</b></h5></td>
                    
                </tr>
                <tr>
                     <td colspan="2"><textarea rows="4" cols="50" style="height: 50px;"></textarea></td>
                </tr>
                <tr>
