...
{   
    ...
    public function SignUp(Request $request) {
        $request->validate([
            ...
            "father_husband_name" => 'required|string|min:10|max:100',
            "designation" => 'required|string|min:2|max:40',
            "hq" => 'required|string|min:4|max:45',
            "address" => 'required|min:30|max:200',
            "dob" => 'required|date',
            "doa" => 'required|date',
            "dor" => 'required|date',
            "permanent_address" => 'required|min:30|max:200',
            "admission_cheque" => 'required|min:5|max:20',
            ...
            "id_number" => 'required|min:8|max:20',
            "railway_id" => 'required|min:8|max:45',
            "introduce_no" => 'nullable|exists:users,membership_code',
            "pf_no" => 'required|min:8|max:40',
            "blood_group" => 'required|min:2|max:3',
            "nominee_salutation" => "required|string|max:5",
            "nominee_name" => 'required|string|min:10|max:100',
            ...
            "nominee_address" => 'required|min:30|max:200',
